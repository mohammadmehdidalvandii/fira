            ...
            <div className="block w-full">
                ...
                <div className="block mt-8">
                    <div className="flex items-center">
                        <span className="block text-primary text-2xl"><FaCheck/></span>
                        <h6 className="block font-dana-bold text-xl mr-3">توسعه شبکه</h6>
                    </div>
                ...
                <div className="block mt-8">
                    <div className="flex items-center">
                        <span className="block text-primary text-2xl"><FaCheck/></span>
                        <h6 className="block font-dana-bold text-xl mr-3">تعریف توسعه</h6>
                    </div>
                    <p className="block text-textColor mt-3">لورم ایپسوم به سادگی ساختار چاپ و متن را در بر می گیرد. لورم ایپسوم به مدت 40 سال استاندارد صنعت بوده است.</p>
                </div>
