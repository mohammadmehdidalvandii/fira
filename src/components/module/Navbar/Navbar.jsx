...
function Navbar() {
  ...
  return (
    <>
      <section className={navbarFixedTop?"hidden lg:block py-4 px-4 bg-white fixed left-0 right-0 shadow-md shadow-gray-200 z-[999] animate-fadeInDownBig":"hidden lg:block py-4 bg-white"}>
      ...
      <section className={navbarFixedTop ? "block lg:hidden py-4 px-4 bg-white fixed left-0 right-0 shadow-md shadow-gray-200 z-[999] animate-fadeInDownBig" :"block lg:hidden py-4 bg-white"}>
        <div className="container">
